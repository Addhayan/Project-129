...
final_data_df = pd.read_csv('scraped_data.csv')

final_data_df.head()

final_data_df.drop(columns=['Unnamed: 0'], inplace=True)
final_data_df.head()

final_data_df = final_data_df.sort_values("pl_name")
final_data_df.tail(10)

final_data_df.to_csv("Merged.csv")